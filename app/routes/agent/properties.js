...
router.get('/:id?', async function(req, res, next){
    if(req.params.id){
        ...
        if(prop){                   
            let rights = await Properties.rights(req.params.id, req.user_profile.manager_id); 
            //console.log(rights)     
            switch(req.query.dest){
                case 'units':
                    if(rights.manage_units){
...
router.get('/new-unit', async function (req, res, next) {
...
router.get('/edit-unit/:id', async function (req, res, next) {
...
router.get('/unit-info/:id', async function (req, res, next) {
    if (req.params.id && req.query.property) {
        let prop = await Properties.info(req.query.property, req.user_profile.manager_id);
        if(prop){
            if(!prop.manage_units){
...
router.get('/tenant-image/:property_code', async function (req, res, next) {
    if (req.query.tenant) {        
...
router.get('/new-tenant', async function (req, res, next) {
    if(req.query.property){
        let prop = await Properties.info(req.query.property, req.user_profile.manager_id);      
        if(prop){
...
router.get('/edit-tenant/:id', async function (req, res){
    if(req.query.property){
        let prop = await Properties.info(req.query.property, req.user_profile.manager_id);      
        if(prop){
            if(!prop.manage_tenants){
...
router.get('/view-tenant/:id', async function (req, res, next){
    if(req.query.property){
        let prop = await Properties.info(req.query.property, req.user_profile.manager_id);      
        if(prop){
            if(!prop.manage_tenants){
...
router.get('/tenant-image/:id', async function (req, res, next){
    if(req.query.property){
        let prop = await Properties.info(req.query.property, req.user_profile.manager_id);      
        if(prop){
            if(!prop.manage_tenants){
...
router.get('/tenant-id-front/:id', async function (req, res, next){
    if(req.query.property){
        let prop = await Properties.info(req.query.property, req.user_profile.manager_id);      
        if(prop){
            if(!prop.manage_tenants){
...
router.get('/tenant-id-back/:id', async function (req, res, next){
    if(req.query.property){
        let prop = await Properties.info(req.query.property, req.user_profile.manager_id);      
        if(prop){
            if(!prop.manage_tenants){
...
router.post('/new-tenant', async function (req, res, next) {    
    if(req.body.property){
        let prop = await Properties.info(req.body.property, req.user_profile.manager_id);        
        if(prop){
            if(!prop.manage_tenants){
...
router.post('/update-tenant', async function (req, res, next){
    if(req.body.property){
        let prop = await Properties.info(req.body.property, req.user_profile.manager_id);        
        if(prop){
            if(!prop.manage_tenants){
...
router.post('/delete-tenant', async function (req, res, next){
...
router.post('/clone-unit', async function (req, res, next) {    
...
router.post('/delete-unit', async function (req, res, next) {
...
router.post('/update-unit', async function (req, res, next) {   
    if (req.body.unit_code && req.body.property) {
        let prop = await Properties.info(req.body.property, req.user_profile.manager_id);
        if(prop){
            if(!prop.manage_units){
...
router.post("/update-unit-label", async function(req, res, next){
...
router.post('/update-quick-tenant', async function (req, res, next){    
...
router.post('/tenant-send-sms', async function (req, res, next){
    let prop = await Properties.info(req.body.property, req.user_profile.manager_id);
    if(prop){
        if(!prop.manage_tenants){
            return res.errorEnd("Not allowed to manage tenants!");
